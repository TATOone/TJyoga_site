  ...
  pillars: [
    {
      ...
      description:
        'Онлайн-занятия в Zoom четыре раза в неделю: хатха из первоисточников, с вариантами под разный уровень и живой обратной связью.',
    },
    {
      id: 'recordings',
  ...
  levels: [
    {
      ...
      title: 'Все уровни',
      description:
        'Зарядка во вторник, утро в пятницу и вечер в среду. Можно приходить с нуля: есть более простой вариант позы и опора на дыхание.',
    },
    {
      id: 'beginners',
      title: 'Начинающие',
    ...
    },
    {
      ...
      title: 'Продолжающие',
      description:
        'Воскресенье вечером: более длинная практика. Имеет смысл, когда регулярная практика уже есть. Новичкам не обязательно.',
    },
  ],
} as const;
  ...
  faq: [
    {
      ...
      a: 'Да. Зарядка, утренняя и вечерняя практики — для всех уровней, есть более простой вариант. Воскресенье длиннее: новичкам оно не обязательно. Перед первым эфиром можно написать в чат, что тревожит в теле.',
    },
    {
...
export const CLUB_SOCIAL_PROOF = [
  { label: 'Практик в неделю', value: '4' },
