...
export const CLUB_SUPPORT = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Продление руками: снова выбираете тариф и оплачиваете. После окончания доступа остаётся 72 часа, чтобы продлить без разрыва.',
    },
  ],
} as const;
...
export const CLUB_SOCIAL_PROOF = [
  ...
  { label: 'На продление', value: '72 часа' },
] as const;
