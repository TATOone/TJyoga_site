...
export const SEED_ARTICLES: readonly SeedArticle[] = [
  ...
  },
  {
    ...
    body: 'Четыре регулярные Zoom-практики в неделю, включая воскресный вечерний блок. Записи появляются в библиотеке в течение суток после эфира. При вопросах пишите в поддержку до 22:00 МСК.',
    category: 'club-news',
    access: 'club',
